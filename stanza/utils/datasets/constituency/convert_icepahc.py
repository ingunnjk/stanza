...
def read_psd_file(input_file):
    """
    Convert the IcePaHC .psd file to id & text
    ...
    # Add the last tree to the output_trees list
    if current_tree:
        cleaned_tree = ' '.join(current_tree.split())
...
def main():
    treebank = convert_icepahc_treebank("/Users/ingunnkristjansdottir/constituency/data/icelandic/is_icepahc/simpleicepahc.psd")
